...
> = {
  cub: {
    ...
    lede: "From overnight camping to STEM workshops, every Cub Scouts meeting is a chance to try something new and bring it home to share.",
    eventTitle: "Pinewood Derby Weekend",
    eventCategory: "Pack Event",
    eventLocation: "Pack 42 Hall · Peoria, IL",
    eventDescription:
      "Build, race, and cheer on your custom car. Trophies, snacks, and big smiles guaranteed.",
    features: [
      {
        title: "Family First",
        description:
          "Parents and siblings are part of every adventure. Dens stick together; families grow together.",
        icon: ICONS.service,
      },
      {
        title: "Hands-On",
        description:
          "Knots, fire-building, robotics, baking. Real skills, taught by real volunteers.",
        icon: ICONS.adventure,
      },
      {
        title: "Belonging",
        description:
          "Every kid gets a den, a uniform, and a circle of friends. Welcoming is the first rule.",
  ...
  scoutsbsa: {
    ...
    lede: "Scouts BSA is the program where young people lead their own patrols, plan their own treks, and discover what they are capable of.",
    eventTitle: "Summit Backpacking Trek",
    eventCategory: "High Adventure",
    eventLocation: "Sangre de Cristo Range · NM",
    eventDescription:
      "Four days, three nights, high altitude. Patrol-planned, patrol-led. YPT required for adults.",
    features: [
      {
        title: "Adventure",
        description:
          "Mountains, rivers, caves, and skies. The outdoors is the classroom, and the curriculum changes weekly.",
        icon: ICONS.adventure,
      },
      {
        title: "Leadership",
        description:
          "Patrol leaders run meetings. Senior patrol leaders run the troop. Adults coach from the back.",
        icon: ICONS.leadership,
      },
      {
        title: "Service",
        description:
          "From neighborhood projects to Eagle Scout community work, Scouts leave places better than they found them.",
        icon: ICONS.service,
      },
    ],
  },
  venturing: {
    ...
    lede: "Venturing is a co-ed, youth-led program for ages 14-20. Plan your own high-adventure crew around your interests: paddling, climbing, robotics, performing arts, anything.",
    eventTitle: "Crew Whitewater Weekend",
    eventCategory: "Crew Trip",
    eventLocation: "Ocoee River · TN",
    eventDescription:
      "Three days, two nights of Class III/IV paddling. Open to certified crew members aged 16+.",
    features: [
      {
        title: "Self-Directed",
        description:
          "Crews choose their own adventures. The program scales to your ambition, not the other way around.",
        icon: ICONS.adventure,
      },
      {
        title: "Team-Led",
        description: "Officers are elected from within. Adults consult; the crew decides.",
        icon: ICONS.leadership,
      },
      {
        title: "Real Impact",
        description:
          "Service hours and community projects count beyond the crew, on resumes, applications, and life.",
        icon: ICONS.service,
      },
    ],
  },
  seascouts: {
    ...
    lede: "Sea Scouts learn maritime skills aboard real vessels: sailing, navigation, engineering, and safe-boating. Adventure on the water builds confidence ashore.",
    eventTitle: "Open Boats Day",
    eventCategory: "Recruitment",
    eventLocation: "Burnham Harbor · Chicago, IL",
    eventDescription:
      "Tour the fleet, meet active Sea Scouts, and try your hand at the helm. Lunch and pier tour included.",
    features: [
      {
        title: "Seamanship",
        description:
          "Knots, lines, navigation, weather, and small-craft handling, taught by experienced ship leaders.",
        icon: ICONS.adventure,
      },
      {
        title: "Crew Leadership",
        description:
          "Boatswain, mate, purser: each role mirrors maritime tradition and modern team management.",
        icon: ICONS.leadership,
      },
      {
        title: "Long Cruise",
        description:
          "Annual long cruises take crews offshore for a week or more of real expedition sailing.",
        icon: ICONS.service,
      },
    ],
  },
    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-3 flex flex-wrap items-center gap-2">
        <span className="flex items-center gap-2 mr-auto">
          <img
            src="/oss/opensourcescouting-logo-color.png"
            alt="Open Source Scouting"
            width={28}
            height={28}
            className="h-7 w-7"
          />
          <span className="display text-sm font-semibold text-program-on-surface">
    ...
    <ScoutThemeProvider program={program} applyToDocument>
      ...
      <main className="max-w-6xl mx-auto px-4 pt-2 sm:pt-4 pb-8 sm:pb-12 flex flex-col gap-12">
        ...
        <section className="flex flex-col gap-5">
          ...
          <Calendar events={buildCalendarEvents(content)} onEventClick={setOpenEvent} />
        </section>
